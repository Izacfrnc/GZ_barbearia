...
async function criar(req, res, tabela, campos) {
  try {
    ...
    console.log(`CREATE ${tabela}`, { campos, valores });
...
router.post("/agendamentos", async (req, res) => {
  try {
    ...
    if (!horarioValido(horario)) {
      return res.status(400).json({ erro: "Horário inválido. Agendamentos só podem ser feitos entre 07:30 e 11:30 ou 13:30 e 19:00, em intervalos de 30 minutos." });
    }
